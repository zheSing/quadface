...
class PolyMesh : public vcg::tri::TriMesh<
        ...
        public:
                ...
                {
                        vcg::tri::Clean<PolyMesh>::RemoveUnreferencedVertex(*this);
                        vcg::tri::Allocator<PolyMesh>::CompactEveryVector(*this);
                        vcg::tri::UpdateNormal<PolyMesh>::PerVertexNormalizedPerFace(*this);
                        vcg::tri::UpdateNormal<PolyMesh>::PerFaceNormalized(*this);
                        vcg::tri::UpdateTopology<PolyMesh>::FaceFace(*this);
                        vcg::tri::UpdateTopology<PolyMesh>::VertexFace(*this);
                        vcg::tri::UpdateFlags<PolyMesh>::VertexBorderFromFaceAdj(*this);
                        vcg::tri::UpdateFlags<PolyMesh>::FaceBorderFromFF(*this);
                }
